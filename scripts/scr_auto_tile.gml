...
nodownleft = (!place_meeting((x - iw), (y + iw), object_index))
noleftleft = (!place_meeting((x - 32), y, object_index))
nodownright = (!place_meeting((x + iw), (y + iw), object_index))
norightright = (!place_meeting((x + (iw * 2)), y, object_index))
noupright = (!place_meeting((x + iw), (y - iw), object_index))
noupleft = (!place_meeting((x - iw), (y - iw), object_index))
